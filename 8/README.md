...
```bash
curl "http://arbond.ru/go/8/notes/651fba2f9a8b5c1234567890"
```
...
```bash
curl -X PATCH http://arbond.ru/go/8/notes/651fba2f9a8b5c1234567890 \
  -H "Content-Type: application/json" \
...
```bash
curl -X DELETE http://arbond.ru/go/8/notes/651fba2f9a8b5c1234567890
```
